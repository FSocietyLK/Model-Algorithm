						...
						<div class="right-panel">
							<div class="right-content">
								<div class="row1">
									...
									<div class="row2">
										<form name="form1" method="post" onsubmit="return error()&&formValidate()" action="<?php require 'insert.php';?>">
											<table cellpadding="10" cellspacing="5" style="font:13px sans-serif">
												<div class="popup" id="popup0" onclick="return drop(0)">
												...
												<tr>
													<td>&nbsp;</td>
													<td><input type="checkbox" id="check" name="check"/>I agree for the terms of use and privacy of the web site.</td>
												</tr>
												<div class="popup" id="popup9" onclick="return drop(9)">
													<div class="close" id="close9"><a href="javascript:void(0);" style="text-decoration: none;color: white">x</a></div>
