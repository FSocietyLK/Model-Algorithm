...
<?php
	require 'connect.php';
	$user=$_SESSION['user'];
	$query="SELECT * FROM `db`.`user` WHERE username='$user'";
						...
						<div class="right-panel">
							<div class="right-content">
								<div class="row1">
									...
									<div class="row2">
										<form name="form1" id="form1" method="post" action="<?php require 'user-update.php';?>">
											<table cellpadding="10" cellspacing="2" style="font:13px sans-serif">
												<div class="popup" id="popup0" style="margin-left:-35px" onclick="return drop(0)">
													<div class="close" id="close0">x</div>
												...
												<div class="popup" id="popup5" onclick="return drop(5)">
													<div class="close" id="close5">x</div>
												...
												<div class="popup" id="popup6" onclick="return drop(6)">
													<div class="close" id="close6">x</div>
												...
												<div class="popup" id="popup7" onclick="return drop(7)">
													<div class="close" id="close7">x</div>
												...
												<tr>
													...
													<td style="padding-right:0px">
														...
														<a href="index.php"><input type="button" id="done" name="done" value="Done"/></a>
													</td>
												</tr>
											</table>
										</form>
